      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number" ><?= countBadges('pending') ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?= countBadges('approved') ?></span>
          </div>
        </div>
      </div>
    </div>              
           ...
           while($row = mysqli_fetch_array($all_data)){
                ?>
                     <tr >
                        ...
                        <td><?= $row['status'] ?></td>
                        <td><?= $row['actioned_by'] ? getUserNameById($row['actioned_by']) : '' ?></td>
                        <td>
                          <?php
