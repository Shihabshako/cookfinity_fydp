        ...
        <nav class="navbar navbar-expand-lg navigation-wraper p-0">
            <div class="container px-0">
              ...
              <div class="cart_icon ms-md-3 ms-1 me-md-0 me-2 d-flex align-items-center">
                <button class="cart-toggle" id="cartBtn" onclick="cartShow()">
                  <span class="material-icons-sharp">
                    shopping_cart
                </span>
                </button>
                  ...
                  <tbody id="tbody">
                    ...
                    <tr class="cart-buttons">
                      <td colspan="2" class="text-center">
                        <button class="px-4 bg-light p-2 rounded-pill fw-bold">View Cart</button>
                      </td>

                      <td colspan="2" class="text-center">
                        <button class="px-4 bg-light p-2 rounded-pill fw-bold" >Checkout</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
                      ...
                      <div class="details p-3">
                        ...
                        <p class="meal-time">
                            Time : <span><?= timeConversion($item['available_from']) ?> </span>
                             -
                            <span><?= timeConversion($item['available_till']) ?></span></p>
                      </div>
                    </div>
                <?php
              }
