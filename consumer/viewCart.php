                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td>
                                    <img width="50px" height="50px" src="../images/meals/<?= $value['image'] ?>" alt="">
                                </td>
                                <td><?= $value['title'] ?></td>
            ...
            <div class="col-md-4 d-flex align-items-center">
                <div class="greenCartBox">
                    ...
                    <div class="cartButtonGroup">
                        ...
                        <button onclick="goCheckout(<?= $total ?>)">Checkout</button>
                    </div>
                </div>
