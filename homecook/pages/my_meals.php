      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number" ><?= countBadgesPerUser('total_meal', $uid) ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number" ><?= countBadgesPerUser('ongoing', $uid) ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?= countBadgesPerUser('expired', $uid) ?></span>
          </div>
        </div>
      </div>
    </div>              
    ...
    <div class="card-body">
        ...
        <div class="table-responsive" >
            <table id="example4" class="table table-bordered table-striped text-center">
                ...
                <tbody>
                  <?php
                    $all_data =getAllMealDetailsPerUser($uid);
                    while($row = mysqli_fetch_array($all_data)){
                      ?>
                          <tr >
                            ...
                            <td><?= timeConversion($row['available_from']) ?></td>
                            <td><?= timeConversion($row['available_till']) ?></td>
                          </tr>
                      <?php
                    }
                  ?>
